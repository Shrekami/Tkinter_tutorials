...
computer_choice=Label(app,text="computer_choice",width=100, height=6,bg="#52f5e8",font="12")
...
winner=Label(app,text="Winner",width=40,bg="#5ff3d4",font="24")
winner.pack(pady=70)
...
rock=Button(app,text="Rock",command=lambda:click_button(rock),width=5,height=1,bg="#f03521")
rock.pack(pady=50,padx=10,fill="x",expand=True,side="left")

paper=Button(app,text="Paper",command=lambda:click_button(paper),width=5,height=1,bg="#7af35f")
paper.pack(padx=10,side="left",fill="x",expand=True)

scissors=Button(app,text="Scissors",command=lambda:click_button(scissors),width=5,height=1,bg="#5f94f3")
